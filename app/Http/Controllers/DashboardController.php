...
class DashboardController extends Controller
{
    ...
    public function dumpUserSurvey()
    {
        ...
        $answers = DB::table('patient_survey')->groupBy('patient_id', 'survey_id', 'order')->distinct()->get();
        ...
        foreach ($answers as $answer) {
            $data[$i] = [
                ...
                'order' => $answer->order,
                'hospital' => PatientProfile::find($answer->patient_id)->hospital->name,
            ];
            $i++;
        }
    ...
    public function downloadToExcel2()
    {
        $export = new UserLogsExport();
        return $export->download('user-log.xlsx');
    }
}
