            ...
            <div class="row">
                <div class="col">
                    <form action="{{ route('kuis.store', $id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            ...
                                            <textarea type="text" class="form-control" name="choice[1][1]" placeholder="pilihan 1" required></textarea>
                                        </div>
                                        <div class="col">
                                            <label for="hoice[1][2]">Pilihan 2</label>
                                            <textarea type="text" class="form-control" name="choice[1][2]" placeholder="pilihan 2" required></textarea>
                                        </div>
                                        <div class="col">
                                            <label for="choice[1][3]">Pilihan 3</label>
                                            <textarea type="text" class="form-control" name="choice[1][3]" placeholder="pilihan 3" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <label for="choice[true][1]">Jawaban Benar</label>
                                            <select name="choice[true][1]" class="form-control" id="true_answer">
                                        ...
                                        <div class="col align-self-end text-right">
                                            <button type="button" class="btn btn-danger" onclick="removeForm(this)">hapus</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="GFG_Fun()">Tambah Pertanyaan</button>
                        <br>
...
@section('js')
    <script>
        ...
        function removeForm(selectedField) {
            selectedField.closest('.form-group').remove();
        }
    </script>
@stop
